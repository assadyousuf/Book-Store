...
COPY public.currentlyincart (id, isbn) FROM stdin;
1	1231234512345
1	1231234512346
1	1231234512347
1	1231234512348
...
SELECT pg_catalog.setval('public.ordertable_id_seq', 6, true);
...
--
-- Name: currentlyincart currentlyincart_cartid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: assadyousuf
--

ALTER TABLE ONLY public.currentlyincart
    ADD CONSTRAINT currentlyincart_cartid_fkey FOREIGN KEY (id) REFERENCES public.cart(id);
